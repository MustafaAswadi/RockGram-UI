...
const Chat = () => {
    ...
    return (
        <div className='col-4'>
                        ...
                        <div className='chat-load'>
                            ...
                            <div className='add-chat-btn-secation'>
                                <div class="col-2 message-text-send">
                                    <button type="submit" class="btn btn-danger" style={{padding:'8px'}} data-bs-toggle="modal" data-bs-target="#addchat">
                    ...
                    <Modal title={`Create ${isPersonal ? 'Personal Chat': 'Groups Chat'}`} id='addchat'>
                        <form class="login-form cart" >
                            <div class="mb-3">
                                <input type="email" class="form-control" id="Email" placeholder="Email" aria-describedby="emailHelp"/>
                            </div>
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-danger btn-login">Create</button>
                            </div>
                        </form>
                    </Modal>
                </div>
